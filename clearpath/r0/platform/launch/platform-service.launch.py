...
def generate_launch_description():
        ...
        launch_arguments=
            [
                (
                    'setup_path'
                    ,
                    '/home/user/dev/phd_assignment_ws/clearpath/r0'
                )
                ,
                (
                    'use_sim_time'
    ...
    node_cmd_vel_bridge = Node(
        ...
        arguments=
            [
                'r0/cmd_vel@geometry_msgs/msg/Twist[ignition.msgs.Twist'
                ,
                '/model/r0/robot/cmd_vel@geometry_msgs/msg/Twist]ignition.msgs.Twist'
                ,
            ]
        ,
        remappings=
    ...
    node_odom_base_tf_bridge = Node(
        ...
        arguments=
            [
                '/model/r0/robot/tf@tf2_msgs/msg/TFMessage[ignition.msgs.Pose_V'
                ,
            ]
        ,
        remappings=
